...
**Типы упражнений:**
- **compound** — тяжелые многосуставные базовые упражнения (приседания, жим, становая, подтягивания, тяги)
- **secondary** — вспомогательные упражнения средней интенсивности для проработки под другими углами
- **isolation** — изолирующие односуставные упражнения для конкретных мышечных групп
...
На основе: уровня клиента (${userProfile.experience}), цели (${userProfile.goal}), доступного времени (${userProfile.timeAvailable} мин)
