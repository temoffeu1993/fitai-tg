...
const OPTIONS: Array<{ value: WorkdayStyle; label: string }> = [
  { value: "sedentary", label: "💻 Работаю головой, а не телом" },
  { value: "balanced", label: "🚶‍♂️ Сидячая работа, но я много хожу пешком" },
  { value: "on_feet", label: "⚡️ Весь день на ногах, почти не присаживаюсь" },
  { value: "heavy_work", label: "🏗️ Моя работа — это уже тяжелая тренировка" },
];
