...
export function buildLevelProgress(totalXpRaw: number): LevelProgress {
...
export function buildGamificationSummary(input: GamificationCounts): GamificationSummary {
