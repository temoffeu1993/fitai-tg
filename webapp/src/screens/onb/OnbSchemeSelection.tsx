...
const DAY_LABEL_MAP: Record<string, DayCopy> = {
  ...
  "Legs":                  { title: "Ноги и ягодицы",   desc: "Приседания и выпады для сильных ног и ягодиц." },
  "Legs A":                { title: "Ноги и ягодицы",   desc: "Приседания и выпады для сильных ног и ягодиц." },
  "Legs B":                { title: "Ноги и ягодицы",   desc: "Другие варианты упражнений на ноги и ягодицы." },
  "Legs Heavy":            { title: "Ноги и ягодицы",   desc: "Тяжёлые приседания — строим силу ног и ягодиц." },
  ...
  "Legs Priority":         { title: "Ноги и ягодицы",   desc: "Сегодня ноги и ягодицы — главный приоритет." },
...
const FALLBACK_DAY_TITLES: Record<string, string[]> = {
  ...
  push_pull_legs: ["Грудь и плечи", "Спина и бицепс", "Ноги и ягодицы"],
  conditioning: ["Круговая тренировка", "Круговая тренировка", "Круговая тренировка"],
  bro_split: ["Грудь", "Спина", "Ноги и ягодицы", "Плечи", "Руки"],
};
...
const FALLBACK_DAY_DESCS: Record<string, string[]> = {
  ...
  push_pull_legs: ["Грудь, плечи и трицепс — всё что «толкает».", "Укрепляем осанку и качаем бицепс.", "Приседания и выпады для сильных ног и ягодиц."],
  conditioning: ["Упражнения подряд почти без пауз — жир горит."],
  bro_split: ["Мощный жим и детальная проработка.", "Ширина спины и здоровая поясница.", "Приседания и выпады для сильных ног и ягодиц.", "Делаем плечи округлыми и сильными.", "Бицепс и трицепс — ничего лишнего."],
};
...
const s: Record<string, React.CSSProperties> = {
  ...
  cardInactive: {
    background: "linear-gradient(180deg, rgba(255,255,255,0.75) 0%, rgba(245,245,250,0.6) 100%)",
    border: "1px solid rgba(255,255,255,0.6)",
    boxShadow: "0 14px 28px rgba(0,0,0,0.08), inset 0 1px 0 rgba(255,255,255,0.85)",
  },
  cardClickable: {
