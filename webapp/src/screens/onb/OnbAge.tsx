  ...
  return (
    <div style={s.page} className={isLeaving ? "onb-leave" : undefined}>
      ...
      <div style={s.progressWrap} className="onb-fade onb-fade-delay-1">
        ...
        <div style={s.progressText}>Шаг 2 из 12</div>
      </div>
...
const s: Record<string, React.CSSProperties> = {
  ...
  ageIndicator: {
    ...
    left: "50%",
    top: "50%",
    width: ITEM_HEIGHT + 28,
    height: ITEM_HEIGHT + 18,
    transform: "translate(-50%, -50%)",
    borderRadius: 16,
    background: "linear-gradient(180deg, rgba(255,255,255,0.55) 0%, rgba(245,245,250,0.2) 100%)",
    border: "1px solid rgba(255,255,255,0.7)",
    boxShadow:
      "0 10px 22px rgba(0,0,0,0.1), inset 0 1px 1px rgba(255,255,255,0.8), inset 0 -1px 1px rgba(255,255,255,0.2)",
