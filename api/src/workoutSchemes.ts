...
// ✅ НОВАЯ СИСТЕМА: Больше не импортируем старые правила из flexibleTemplates.js
// Теперь используем templateRulesId → TRAINING_RULES_LIBRARY из trainingRulesLibrary.ts
...
export const workoutSchemes: WorkoutScheme[] = [
    ...
    dayLabels: [
      {
        ...
        templateRulesId: "Full Body A" // 🔥 НОВАЯ СИСТЕМА - передняя цепь
      },
      {
        day: 2,
        label: "Full Body B",
        focus: "Упор на спину и плечи: тяги, жим над головой, подтягивания и их варианты.",
        templateRulesId: "Full Body B" // 🔥 НОВАЯ СИСТЕМА - задняя цепь
      },
      {
        day: 3,
        label: "Full Body C",
        focus: "Выпады, наклонные жимы, тяги к поясу и дополнительные упражнения для баланса.",
        templateRulesId: "Full Body C" // 🔥 НОВАЯ СИСТЕМА - сбалансированная
      },
    ],
    benefits: [
    ...
    dayLabels: [
      {
        ...
        templateRulesId: "Upper Body" // 🔥 НОВАЯ СИСТЕМА
      },
      {
        day: 2,
        label: "Lower Focus",
        focus: "Акцент на низ: бёдра, ягодицы, задняя поверхность бедра.",
        templateRulesId: "Lower Body" // 🔥 НОВАЯ СИСТЕМА
      },
      {
        day: 3,
        label: "Full Body",
  ...
  },
  {
    ...
    splitType: "full_body",
    experienceLevels: ["beginner", "intermediate", "advanced"],
    goals: ["athletic_body", "build_muscle"],
    equipmentRequired: ["gym_full"],
    dayLabels: [
      {
        day: 1,
    ...
    dayLabels: [
      {
        ...
        templateRulesId: "Upper A" // 🔥 НОВАЯ система - акцент на грудь и горизонт
      },
      {
        day: 2,
        label: "Lower A",
        focus: "Приседания, наклоны, упражнения на икры — основа для сильных ног.",
        templateRulesId: "Lower A" // 🔥 НОВАЯ система - акцент на квадрицепсы
      },
      {
        day: 3,
        label: "Upper B",
        focus: "Жимы вверх, подтягивания и упражнения на руки для других углов нагрузки.",
        templateRulesId: "Upper B" // 🔥 НОВАЯ система - акцент на спину и вертикаль
      },
      {
        day: 4,
        label: "Lower B",
        focus: "Выпады, варианты приседаний и ягодичный мост — акцент на форме ног и ягодиц.",
        templateRulesId: "Lower B" // 🔥 НОВАЯ система - акцент на ягодицы и заднюю цепь
      },
    ],
    benefits: [
    ...
    dayLabels: [
      {
        ...
        templateRulesId: "Push A" // 🔥 НОВАЯ система - тяжёлые жимы, акцент на грудь
      },
      {
        day: 2,
        label: "Pull A",
        focus: "Спина, задняя часть плеч и бицепс — базовые тяги и подтягивания.",
        templateRulesId: "Pull A" // 🔥 НОВАЯ система - акцент на ширину спины
      },
      {
        day: 3,
        label: "Legs A",
        focus: "Квадрицепсы, ягодицы, икры — основные упражнения на ноги.",
        templateRulesId: "Legs A" // 🔥 НОВАЯ система - акцент на квадрицепсы
      },
      {
        day: 4,
        label: "Push B",
        focus: "Жимы под другими углами и дополнительные упражнения на плечи и трицепс.",
        templateRulesId: "Push B" // 🔥 НОВАЯ система - объёмная работа, акцент на плечи
      },
      {
        day: 5,
        label: "Pull B",
        focus: "Другие варианты тяг и упражнений на спину и бицепс.",
        templateRulesId: "Pull B" // 🔥 НОВАЯ система - акцент на толщину спины
      },
    ],
    benefits: [
  ...
  },
  {
    ...
    dayLabels: [
      ...
      },
      {
        ...
        templateRulesId: "Lower B" // 🔥 НОВАЯ система - акцент на ягодицы (снова Lower B с др. фокусом)
      },
    ],
    benefits: [
  ...
  },
  {
    ...
    splitType: "full_body",
    experienceLevels: ["beginner", "intermediate", "advanced"],
    goals: ["athletic_body", "health_wellness"],
    equipmentRequired: ["gym_full"],
    dayLabels: [
      {
        day: 1,
    ...
    dayLabels: [
      {
        ...
        templateRulesId: "Push A" // 🔥 НОВАЯ система - силовые жимы, грудь
      },
      {
        day: 2,
        label: "Pull A",
        focus: "Тяжёлые тяги с акцентом на спину.",
        templateRulesId: "Pull A" // 🔥 НОВАЯ система - ширина спины
      },
      {
        day: 3,
        label: "Legs A",
        focus: "Приседания, наклоны и другие базовые упражнения на ноги.",
        templateRulesId: "Legs A" // 🔥 НОВАЯ система - квадрицепсы
      },
      {
        day: 4,
        label: "Push B",
        focus: "Более объёмная работа на грудь и плечи.",
        templateRulesId: "Push B" // 🔥 НОВАЯ система - объёмная работа, плечи
      },
      {
        day: 5,
        label: "Pull B",
        focus: "Больше повторений и вариаций тяг на спину.",
        templateRulesId: "Pull B" // 🔥 НОВАЯ система - толщина спины
      },
      {
        day: 6,
        label: "Legs B",
        focus: "Другие варианты приседаний и выпадов для ног.",
        templateRulesId: "Legs B" // 🔥 НОВАЯ система - ягодицы и задняя цепь
      },
    ],
    benefits: [
  ...
  // Новичкам на 4 дня
  {
    ...
    dayLabels: [
      ...
      },
      {
        ...
        templateRulesId: "Full Body C" // 🔥 НОВАЯ СИСТЕМА
      },
      {
        day: 4,
        label: "Full Body D",
        focus: "Повторение базы с чуть меньшими весами и акцентом на технику.",
        templateRulesId: "Full Body A" // 🔥 НОВАЯ СИСТЕМА - повтор A но AI сгенерирует иначе
      },
    ],
    benefits: [
