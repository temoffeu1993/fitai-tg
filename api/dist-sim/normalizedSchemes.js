...
export const NORMALIZED_SCHEMES = [
    ...
    // ==========================================================================
    {
        ...
        description: "Две тренировки на всё тело — безопасный и эффективный старт для формы и похудения.",
        splitType: "full_body",
        daysPerWeek: 2,
        ...
        notes: "Для похудения добавляй шаги/кардио отдельно; силовые держи стабильными.",
    },
    {
        id: "fb_2x_recovery_gentle",
        name: "Full Body 2x Gentle",
        russianName: "Мягкое начало 2 дня",
        description: "Щадящий вариант для после перерыва/низкой готовности: техника, умеренный объём, контроль.",
        splitType: "full_body",
        daysPerWeek: 2,
        timeBuckets: [45, 60],
        ...
        notes: "Если есть постоянная боль/симптомы — включай ограничения через constraint tags и смещай тренировки в low-impact.",
    },
    {
        id: "lower_focus_2x_glutes_legs",
        name: "Lower Focus 2x",
        russianName: "Ноги и ягодицы 2 раза",
        description: "Два мощных дня на нижнюю часть: один — квадро/ягодицы, второй — задняя/ягодицы.",
    ...
    },
    {
        ...
        description: "Тяжёлая силовая программа: максимальные веса, долгое восстановление, акцент на базовые движения.",
        ...
        notes: "Требует отличной техники и опыта работы с тяжёлыми весами. Не для новичков.",
    },
    {
        id: "maintenance_2x_advanced",
        name: "Maintenance 2x Advanced",
        russianName: "Поддержка формы 2 дня (продвинутые)",
        description: "Минималистичная программа для поддержки силы и массы при занятом графике или в период восстановления.",
        splitType: "full_body",
        daysPerWeek: 2,
        timeBuckets: [45, 60],
        ...
        days: [
            {
                ...
                templateRulesId: "Full Body A",
                requiredPatterns: ["squat", "horizontal_push", "horizontal_pull", "core"],
                optionalPatterns: ["arms_iso", "calves"],
            },
            {
                day: 2,
                label: "Full Body B",
        ...
        notes: "Не для роста массы — только поддержка. При наличии времени лучше вернуться к 3-4 дням.",
    },
    // ==========================================================================
    // 3 DAYS / WEEK
    // ==========================================================================
    {
        ...
        description: "Три тренировки на всё тело (A/B/C) — лучший универсальный вариант для новичка и большинства людей.",
        splitType: "full_body",
        daysPerWeek: 3,
        timeBuckets: [45, 60, 90],
        ...
        days: [
            ...
            },
            {
                ...
                optionalPatterns: ["rear_delts", "arms_iso", "calves"],
            },
            {
                day: 3,
                label: "Full Body C",
    ...
    },
    {
        ...
        description: "Два дня с фокусом (верх/низ) и один день всё тело — гибкая схема для формы и массы.",
        ...
        days: [
            {
                ...
                optionalPatterns: ["incline_push", "delts_iso", "arms_iso", "rear_delts", "core"],
            },
            {
                day: 2,
                label: "Lower Body",
            ...
            },
            {
                ...
                optionalPatterns: ["rear_delts", "calves", "arms_iso"],
            },
        ],
        benefits: [
    ...
    },
    {
        ...
        description: "Классический PPL в 3 дня — плотные тренировки для тех, кто хочет массу/силу при 3 посещениях.",
        ...
        notes: "Для новичка PPL 3× показывай только если время 60–90 и нет ограничений; иначе лучше Full Body 3×.",
    },
    {
        id: "fat_loss_3x_beginner",
        name: "Fat Loss 3x Beginner",
        russianName: "Похудение: 3 дня (безопасно)",
        description: "Силовая база + низкоударная кондиция. Без прыжков и «убийства» — устойчиво для новичка.",
        ...
        days: [
            ...
            },
            {
                ...
                optionalPatterns: ["arms_iso", "rear_delts"],
            },
            {
                day: 3,
        ...
        notes: "Если есть ограничения по суставам/весу — ставь constraint avoid_high_impact и держи conditioning low-impact.",
    },
    // ==========================================================================
    // 4 DAYS / WEEK
    // ==========================================================================
    {
        ...
        description: "Два раза верх, два раза низ — золотой стандарт для массы/формы и прогресса.",
        splitType: "upper_lower",
        daysPerWeek: 4,
        timeBuckets: [45, 60, 90],
        goals: ["build_muscle", "strength", "athletic_body", "lose_weight"],
        ...
        days: [
            ...
            },
            {
                ...
                optionalPatterns: ["horizontal_push", "rear_delts", "arms_iso", "delts_iso", "core"],
            },
            {
                day: 4,
                label: "Lower B",
    ...
    },
    {
        ...
        description: "2 силовых дня + 2 объёмных дня. Для тех, кто хочет и рост мышц, и рост силовых.",
        splitType: "upper_lower",
        daysPerWeek: 4,
        timeBuckets: [60, 90],
        goals: ["strength", "build_muscle"],
        ...
        days: [
            {
                ...
                optionalPatterns: ["vertical_pull", "arms_iso", "rear_delts"],
            },
            {
                day: 2,
                label: "Lower Power",
            ...
            },
            {
                ...
                templateRulesId: "Upper B",
                requiredPatterns: ["incline_push", "vertical_pull", "horizontal_pull", "delts_iso", "arms_iso"],
                optionalPatterns: ["rear_delts"],
            },
            {
                day: 4,
    ...
    },
    {
        ...
        description: "3 дня на низ + 1 день поддержка верха. Специализация на 6–12 недель.",
        splitType: "lower_focus",
        daysPerWeek: 4,
        timeBuckets: [60, 90],
        goals: ["lower_body_focus", "build_muscle", "athletic_body", "lose_weight"],
        ...
        notes: "Держи специализацию ограниченным блоком. Потом возвращайся к сбалансированному сплиту.",
    },
    {
        id: "fat_loss_4x_strength_conditioning",
        name: "Fat Loss 4x Hybrid",
        russianName: "Похудение: силовые + кондиция (4 дня)",
        description: "Два силовых дня + два дня low-impact интервалов/кругов. Для устойчивого похудения.",
        splitType: "conditioning",
        daysPerWeek: 4,
        timeBuckets: [45, 60],
    ...
    // ==========================================================================
    {
        ...
        description: "Большой объём для роста: Push A / Pull A / Legs A / Push B / Pull B.",
        splitType: "push_pull_legs",
        daysPerWeek: 5,
        timeBuckets: [45, 60, 90],
        goals: ["build_muscle", "strength", "athletic_body"],
        ...
        notes: "Для 45 минут важна плотность: суперсеты допускаются, но без ухудшения техники.",
    },
    {
        id: "ulul_leg_5x_legs_priority",
        name: "Upper/Lower/Extra Legs 5x",
        russianName: "Верх/низ + доп. ноги (5 дней)",
        description: "Ноги и ягодицы в приоритете при сохранении верха: Upper A / Lower A / Upper B / Lower B / Legs (pump).",
        splitType: "upper_lower",
        daysPerWeek: 5,
        timeBuckets: [45, 60],
    ...
    },
    {
        ...
        description: "Сила + мощность + гипертрофия + кондиция + восстановление. Для общего атлетического тела.",
        splitType: "full_body",
        daysPerWeek: 5,
        timeBuckets: [45, 60],
        ...
        days: [
            ...
            },
            {
                ...
                optionalPatterns: ["delts_iso", "arms_iso"],
            },
            {
                day: 4,
                label: "Conditioning",
    ...
    // ==========================================================================
    {
        ...
        description: "Два круга PPL за неделю: максимальная частота для роста (только при хорошем восстановлении).",
        splitType: "push_pull_legs",
        daysPerWeek: 6,
        timeBuckets: [45, 60, 90],
        ...
        notes: "Если чек-ин показывает усталость — автоматически снижать объём/интенсивность (mode light/recovery).",
    },
    {
        id: "ul_6x_intensive",
        name: "Upper/Lower 6x Intensive",
        russianName: "Верх/низ 6 дней (интенсив)",
        description: "Heavy / Volume / Pump распределение по верху и низу — для продвинутых, кто любит структуру.",
        splitType: "upper_lower",
        daysPerWeek: 6,
        timeBuckets: [45, 60],
        goals: ["build_muscle", "strength"],
        ...
        days: [
            ...
            { day: 3, label: "Upper Volume", focus: "Объём на верх.", templateRulesId: "Upper B", requiredPatterns: ["incline_push", "vertical_pull", "horizontal_pull", "delts_iso"], optionalPatterns: ["arms_iso", "rear_delts"] },
            ...
            { day: 5, label: "Upper Pump", focus: "Пампинг/изоляция верха.", templateRulesId: "Upper Body", requiredPatterns: ["rear_delts", "arms_iso", "horizontal_pull"], optionalPatterns: ["incline_push"] },
    ...
    },
    {
        ...
        description: "Каждый день — своя группа. Только для продвинутых и любителей классики бодибилдинга.",
        splitType: "bro_split",
        daysPerWeek: 6,
        timeBuckets: [60, 90],
        goals: ["build_muscle"],
        ...
        notes: "Если пользователь не «в теме» — лучше предлагать PPL/Upper-Lower как более научный вариант.",
    },
];
export function getCandidateSchemes(user) {
...
export function rankSchemes(user, candidates) {
    ...
    const scored = candidates.map(s => {
        ...
        if (bmi >= 30) {
            if (s.splitType === "conditioning")
                score -= 6;
            if (s.intensity === "high")
                score -= 2;
            if (s.splitType === "full_body" || s.splitType === "upper_lower")
                score += 2;
        }
