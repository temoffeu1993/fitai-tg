...
const s: Record<string, React.CSSProperties> = {
  ...
  introImage: {
    ...
    WebkitMaskImage: "linear-gradient(180deg, #000 0%, #000 55%, rgba(0,0,0,0.2) 70%, transparent 100%)",
    maskImage: "linear-gradient(180deg, #000 0%, #000 55%, rgba(0,0,0,0.2) 70%, transparent 100%)",
  },
  introTextBlock: {
    width: "100%",
    textAlign: "center",
