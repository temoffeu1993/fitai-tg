...
В расчёте времени учитывай, что базовые упражнения (многосуставные) занимают ~12 минут каждое (подходы + отдых), изолирующие ~5–6 минут.
В эти 12 / 5–6 уже заложен отдых между подходами — не оставляй отдельный запас времени, заполняй основную часть полностью.
...
- Соблюдай фокус дня: Push/Upper — толкающие движения верхом без ног; Pull — тяговые движения верхом без ног; Legs — нижняя часть тела (ядро/кор допустим); Full Body — сбалансируй: упражнения на ноги, на тягу, на толчок
- Указывай рабочий вес в кг так, чтобы последние 1–2 повтора были с усилием (RPE ~8). Если нет данных — подбери сам вес на основе данных пользователя и его состояния из чекина.
