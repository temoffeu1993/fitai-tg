...
Опирайся на концепции тренировочного объёма:

- **MEV** (Minimum Effective Volume): минимальный объём для начала роста
- **MAV** (Maximum Adaptive Volume): оптимальный диапазон для максимального прогресса
- **MRV** (Maximum Recoverable Volume): потолок, выше которого начинается перетренированность

**Общие ориентиры MAV (подходов/неделю):**
- Крупные мышечные группы (грудь, спина, квадрицепсы): 12-20 подходов
- Средние группы (плечи, бицепс, трицепс, задняя поверхность бедра): 8-14 подходов
- Малые группы (икры, пресс, предплечья): 6-12 подходов

**Адаптация под уровень:**
- Новички (beginner): ближе к MEV (нижняя граница MAV)
- Средний (intermediate): середина MAV
- Продвинутые (advanced): верхняя граница MAV, можно подходить к MRV

**Важно:** 
- Это тренировка 1 раз/неделю на эту группу → планируй НЕДЕЛЬНЫЙ объём за одну сессию
- Учитывай работу синергистов
- Используй свои знания Volume Landmarks для конкретных мышечных групп
