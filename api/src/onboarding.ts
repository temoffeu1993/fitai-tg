...
ВАЖНО: поле расписания daysPerWeek — это планы пользователя и готовность, а НЕ то, что он уже делает.
Формулируй как «готов(а) заниматься N раз в неделю», а не «занимаешься…».
Учитывай возраст, пол, рост, вес, опыт, количество тренировок в неделю, локацию и оборудование, ограничения по здоровью, стиль питания, продукты которые нельзя или не любит и бюджет на продукты, образ жизни, сон, уровень стресса, мотивацию и цель.
