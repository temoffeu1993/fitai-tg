  ...
  "exercises": [
    {
      ...
      "rest": 120,
      "weight": "85 кг",
      "cues": "Лопатки сведены, опускай до груди, локти 45°",
      "targetMuscles": ["грудь", "трицепс", "передняя дельта"]
    },
    {
      ...
      "rest": 90,
      "weight": "32 кг (каждая)",
      "cues": "Контролируемое опускание, полная амплитуда",
      "targetMuscles": ["грудь", "передняя дельта"]
    },
    {
      ...
      "rest": 90,
      "weight": "55 кг",
      "cues": "Пресс напряжён, траектория строго вверх",
      "targetMuscles": ["плечи", "трицепс"]
    }
  ],
  "adaptationNotes": ["Хорошая энергия, можно увеличить интенсивность на следующей неделе"],
  "warnings": []
}
\`\`\`
