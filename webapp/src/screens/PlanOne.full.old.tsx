...
export default function PlanOneNew() {
  ...
  const plan: Plan = {
    ...
    warmup: [
      "Кардио 3-5 минут (беговая дорожка или велотренажёр)",
      "Вращения руками 10-15 раз",
      "Лёгкие приседания 10-15 раз",
      "Жим пустого грифа 10 раз",
    ],
    exercises: [
      {
        ...
        reps: [6, 10],
        restSec: 120,
        cues: "Лопатки собраны. Контроль эксцентрики",
        targetMuscles: ["chest", "triceps"],
        equipment: ["barbell", "bench"],
        difficulty: 4,
        technique: {
          setup: "Ляг на скамью, лопатки сведены вместе",
          execution: "Опусти штангу к груди, толкай вверх",
          commonMistakes: ["Прогиб в пояснице", "Локти слишком широко"],
        },
      },
      {
        ...
        reps: [8, 12],
        restSec: 90,
        cues: "Запястья ровно. Контроль движения",
        targetMuscles: ["chest", "front_delts"],
      ...
      {
        name: "Французский жим EZ-штанги",
        sets: 3,
        reps: [10, 12],
        restSec: 90,
        targetMuscles: ["triceps"],
      ...
      {
        name: "Разведение в тренажёре (задняя дельта)",
        sets: 3,
        reps: [15, 20],
        restSec: 60,
    ...
    cooldown: [
      ...
      "Растяжка плеч 30 сек каждой",
      "Растяжка трицепса 30 сек каждой",
